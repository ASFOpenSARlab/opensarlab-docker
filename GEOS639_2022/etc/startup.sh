...
cp "${UNAVCO_FILES}"/install_unavco_pkgs.sh /home/jovyan/.local/install_unavco_pkgs.sh
...
cp "${UNAVCO_FILES}"/00-df.py $HOME/.ipython/image_default/startup/00-df.py
...
gitpuller https://github.com/uafgeoteach/GEOS639-InSARGeoImaging.git main $HOME/GEOS639-InSAR
